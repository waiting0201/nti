...
| [內容匯入](db/content/README.md) | `db/content/`：把 mockup 的內容匯入 CMS——頁面 111 筆、舊站 301 對照 227 條、網站設定 10 個 key、四個方案的頁面文案（中英雙語）。**中文為初稿待客戶校閱** |
...
│   ├── content/       # 一次性內容匯入（mockup 的實際內容，中英雙語）
│   ├── verify/        # 建置後自我檢核
