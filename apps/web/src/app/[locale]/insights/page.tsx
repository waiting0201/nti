...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <section className="fac-banner"><img src="/assets/green-tree.jpg" alt="NTI Printing Insights — sustainable packaging knowledge hub" /></section>
      <section className="section"><div className="wrap">
        ...
        <div className="vl-grid mt-l">
          <A className="vl-card reveal" href={l("/news")}>
            <span className="vl-thumb"><img src="/assets/news/global-views-esg-award.jpg" alt="" loading="lazy" /></span>{' '}
          ...
          <A className="vl-card reveal" href={l("/faq")}>
            <span className="vl-thumb"><img src="/assets/fac-pre-proof.jpg" alt="" loading="lazy" /></span>{' '}
          ...
          <A className="vl-card reveal" href={l("/industry-trends")}>
            <span className="vl-thumb"><img src="/assets/sol-patterns.jpg" alt="" loading="lazy" /></span>{' '}
