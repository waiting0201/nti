...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return pageMetadata(locale, "/about-difference", {
    ...
    description: "One of Taiwan's most certified eco-friendly printing companies. See how NTI pairs premium print quality with sustainable packaging for global brands.",
  })
}
...
export default async function Page({ params }: Props) {
  ...
  const page = await getPage(locale, 'about-difference')
