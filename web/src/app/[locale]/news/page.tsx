...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <section className="fac-banner"><img src="/assets/diff-grid.jpg" alt="NTI Printing news — sustainably printed packaging patterns" /></section>
      <section className="section"><div className="wrap">
        ...
        <A href={l("/news-global-views-esg-award")} className="news-feature reveal mt-l">
          <div className="nf-img"><img src="/assets/news/global-views-esg-award.jpg" alt="NTI wins a 2026 Global Views ESG Award for low-carbon operations" /></div>
        ...
        <div className="news-grid">
          <A href={l("/news-firefighter-boardgame")} className="ncard reveal" data-d="1">
            <div className="nc-img"><img src="/assets/news/firefighter-boardgame.jpg" alt="" loading="lazy" /></div>
          ...
          <A href={l("/news-national-sustainable-development-award")} className="ncard reveal" data-d="2">
            <div className="nc-img"><img src="/assets/news/national-sustainable-development-award.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-taicca-partnership")} className="ncard reveal" data-d="3">
            <div className="nc-img"><img src="/assets/news/taicca-partnership.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-green-printing-digital-innovation")} className="ncard reveal" data-d="1">
            <div className="nc-img"><img src="/assets/news/green-printing-digital-innovation.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-green-drive-seminar")} className="ncard reveal" data-d="2">
            <div className="nc-img"><img src="/assets/news/green-drive-seminar.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-animals-of-tomorrow")} className="ncard reveal" data-d="3">
            <div className="nc-img"><img src="/assets/news/animals-of-tomorrow.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-gentle-wild-paper-bags")} className="ncard reveal" data-d="1">
            <div className="nc-img"><img src="/assets/news/gentle-wild-paper-bags.png" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-hp-variable-data-printing")} className="ncard reveal" data-d="2">
            <div className="nc-img"><img src="/assets/news/hp-variable-data-printing.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-sme-investment-benchmark")} className="ncard reveal" data-d="3">
            <div className="nc-img"><img src="/assets/news/sme-investment-benchmark.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-commonwealth-interview")} className="ncard reveal" data-d="1">
            <div className="nc-img"><img src="/assets/news/commonwealth-interview.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
          ...
          <A href={l("/news-low-carbon-production-film")} className="ncard reveal" data-d="2">
            <div className="nc-img"><img src="/assets/news/low-carbon-production-film.jpg" alt="" loading="lazy" /></div>
            <div className="nc-body">
